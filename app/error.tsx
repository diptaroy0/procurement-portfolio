...
export default function Error({
  ...
  return (
    <main className="min-h-screen bg-[#081120] flex items-center justify-center px-6">
      {/* Background Glow */}
      ...
      <motion.div
        ...
        className="relative z-10 max-w-xl rounded-3xl border border-cyan-400/20 bg-[#0f1c31]/80 p-10 backdrop-blur-xl text-center shadow-2xl"
      >
        {/* Icon */}
        <motion.div
          animate={{
